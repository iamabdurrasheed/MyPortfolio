  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Mohammed Abdur Rasheed",
          from_email: form.email,
          to_email: "22bd1a0538@gmail.com",
          ...
          >
            <label className='flex flex-col'>
              ...
              <input
                ...
                className='bg-[rgba(255,255,255,0.05)] py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
              />
            </label>
            <label className='flex flex-col'>
